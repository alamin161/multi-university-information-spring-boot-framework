...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-private-university-achievement",function (data) {
                ...
                $("#divPrivateVarsityAchievement").html(priVarsityResearchData);
    ...
    <main class="content">
        <div class="container-fluid p-0">
            <div class="row">
                <div id="existing-private-varsity-achievement" class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">  Private University Achievement</h5>
                            <h6 class="card-subtitle text-muted">This table is for all private university achievement information</h6>
                        </div>
                        <div class="card-body">
                            <div id="divPrivateVarsityAchievement"></div>
                        </div>
                    </div>
                </div>
            </div>
