<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewPublicVarsity() {
            $.post("get-all-private-medical-college",function (data) {
                ...
                $("#divMedicalCollege").html(publicVarsityData);
        ...
        <div id="existing-medicalCollege" class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Existing Private Medical College</h5>
                    <h6 class="card-subtitle text-muted">This table is for all private Medical college information</h6>
                </div>
                <div class="card-body">
                    <div id="divMedicalCollege"></div>
                </div>
            </div>
            </div>
        </div>
