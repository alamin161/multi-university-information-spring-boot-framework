...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-private-university-teacher",function (data) {
                ...
                $("#divPrivateUniversityTeacher").html(engVarsityData);
        ...
        <div id="existing-engineeringUniversity" class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Private University Teacher</h5>
                    <h6 class="card-subtitle text-muted">This table is for all private university teacher information</h6>
                </div>
                <div class="card-body">
                    <div id="divPrivateUniversityTeacher"></div>
                </div>
            </div>
        </div>
    </div>
