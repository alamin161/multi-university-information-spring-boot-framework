...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-public-medical-college-research",function (data) {
                ...
                $("#divPublicMedicalResearch").html(priVarsityResearchData);
        ...
        <div id="existing-engineeringUniversity" class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Public Medical College Research</h5>
                    <h6 class="card-subtitle text-muted">This table is for all public medical college research information</h6>
                </div>
                <div class="card-body">
                    <div id="divPublicMedicalResearch"></div>
                </div>
            </div>
        </div>
        </div>
