...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-engineering-university-teacher",function (data) {
                ...
                $("#divEngineeringUniversityTeacher").html(engVarsityData);
        ...
        <div id="existing-engineeringUniversity" class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">  Engineering University Teacher</h5>
                    <h6 class="card-subtitle text-muted">This table is for all engineering university teacher information</h6>
                </div>
                <div class="card-body">
                    <div id="divEngineeringUniversityTeacher"></div>
                </div>
            </div>
        </div>
    </div>
