...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-engineering-university-research",function (data) {
                ...
                $("#divEngineeringResearch").html(priVarsityResearchData);
...
<main class="content">
    <div class="container-fluid p-0">
        <div class="row">
        <div id="existing-engineeringResearch" class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> Engineering University Research</h5>
                    <h6 class="card-subtitle text-muted">This table is for all engineering university research information</h6>
                </div>
                <div class="card-body">
                    <div id="divEngineeringResearch"></div>
                </div>
            </div>
            </div>
        </div>
