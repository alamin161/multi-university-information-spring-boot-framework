...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-public-university-research",function (data) {
                ...
                $("#divPublicUniversityResearch").html(priVarsityResearchData);
        ...
        <div id="existing-engineeringUniversity" class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Public University Research</h5>
                    <h6 class="card-subtitle text-muted">This table is for all public university information research information</h6>
                </div>
                <div class="card-body">
                    <div id="divPublicUniversityResearch"></div>
                </div>
            </div>
        </div>
        </div>
