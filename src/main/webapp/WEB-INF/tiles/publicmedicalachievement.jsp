...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-public-medical-college-achievement",function (data) {
                ...
                $("#divPublicMedicalAchievement").html(priVarsityResearchData);
    ...
    <main class="content">
        <div class="container-fluid p-0">
            <div class="row">
                <div id="existing-public-medical-achievement" class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">  Public Medical College Achievement</h5>
                            <h6 class="card-subtitle text-muted">This table is for all public medical college achievement information</h6>
                        </div>
                        <div class="card-body">
                            <div id="divPublicMedicalAchievement"></div>
                        </div>
                    </div>
                </div>
            </div>
