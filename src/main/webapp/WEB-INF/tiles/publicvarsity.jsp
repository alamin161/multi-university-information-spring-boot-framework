<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewPublicVarsity() {
            $.post("get-all-public-university",function (data) {
                ...
                $("#divPublicUniversity").html(publicVarsityData);
    ...
    <main class="content">
        <div class="container-fluid p-0">
            <div class="row">
        <div id="existing-publicUniversity" class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Existing Public University</h5>
                    <h6 class="card-subtitle text-muted">This table is for all public university information</h6>
                </div>
                <div class="card-body">
                    <div id="divPublicUniversity"></div>
                </div>
            </div>
        </div>
        </div>
