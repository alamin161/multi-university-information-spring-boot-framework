...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-public-university-achievement",function (data) {
                ...
                $("#divPublicVarsityAchievement").html(priVarsityResearchData);
    ...
    <main class="content">
        <div class="container-fluid p-0">
            <div class="row">
                <div id="existing-public-varsity-achievement" class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">  Public University Achievement</h5>
                            <h6 class="card-subtitle text-muted">This table is for all public university achievement information</h6>
                        </div>
                        <div class="card-body">
                            <div id="divPublicVarsityAchievement"></div>
                        </div>
                    </div>
                </div>
            </div>
