...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-private-university-research",function (data) {
                ...
                $("#divPrivateUniversityResearch").html(priVarsityResearchData);
        ...
        <div id="existing-engineeringUniversity" class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Private University Research</h5>
                    <h6 class="card-subtitle text-muted">This table is for all private university research information</h6>
                </div>
                <div class="card-body">
                    <div id="divPrivateUniversityResearch"></div>
                </div>
            </div>
        </div>
        </div>
