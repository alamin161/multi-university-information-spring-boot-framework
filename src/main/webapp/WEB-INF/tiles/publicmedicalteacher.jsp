...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function funViewEngVarsityData() {
            $.post("get-all-public-medical-college-teacher",function (data) {
                ...
                $("#divPublicMedicalTeacher").html(engVarsityData);
        ...
        <div id="existing-engineeringUniversity" class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Public Medical College Teacher</h5>
                    <h6 class="card-subtitle text-muted">This table is for all public medical college teacher information</h6>
                </div>
                <div class="card-body">
                    <div id="divPublicMedicalTeacher"></div>
                </div>
            </div>
        </div>
    </div>
